@EndUserText.label: 'CONSUMPTION ZI_ZTRAVEL_TECH_SRS FOR APPR'
...
define root view entity ZIFV_CDS_TRAVEL_APP
  ...
  as projection on ZIFV_CDS_TRAVEL
{
  ...
  key TravelId,
      ...
      /* Associations */
      _Agency,
      _Booking : redirected to composition child ZPCV_ZIFV_CDS_BOOKING_APP,
      _Currency,
      _Customer,
      _Status
}
